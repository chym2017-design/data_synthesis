...
用法:
    python docs/test_embedding.py                                 # 使用内置默认文本测试
    python docs/test_embedding.py --text "测试文本"                  # 单文本向量化
    python docs/test_embedding.py --texts "文本A" "文本B" "文本C"    # 多文本，输出相似度矩阵
    python docs/test_embedding.py --pair "文本A" "文本B"             # 两文本，输出余弦相似度
"""
