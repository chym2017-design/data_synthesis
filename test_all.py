...
用法:
    python test_all.py                      # 全部测试（合成 5 条样本）
    python test_all.py --samples 10         # 指定合成样本数
    python test_all.py --skip-synthesis     # 跳过合成和后质检，仅测 LLM/Embedding/前质检
"""
...
TEMPLATE_DIR = SCRIPT_DIR / "synth_engine" / "templates" / "bank_intent"
